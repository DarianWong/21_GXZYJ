...
//    SPDAT = 0;
//    SPSTAT = 0XC0;
//    SPCTL = 0XD3; // MSB 上升沿驱动，下降沿采样CPU_CLK/16
////	 SPCTL = 0XD3;
//}


////uchar RC522_Init(void)
////{
////    SPI_Init();
////    PcdReset();
////    PcdAntennaOff();
